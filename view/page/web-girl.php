...
<div class="container-fluid w-100 pt-5">
    ...
    <?php }else{ ?>
    <div class="container">
        <h3 class="font-weight-bold poppins-regular text-uppercase mt-5 pt-5">Damas</h3>
        <hr>
    </div>
            ...
            <div class="col-12 col-sm-4 text-center text-sm-end">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="OrderSubMenu">
                        ...
                        <a class="dropdown-item" href="<?php echo URL.$pagina[0]."/".$pagina[1]."/MIN/1/"; ?>">Precio
                            (Menor a Mayor)</a>
                        <a class="dropdown-item" href="<?php echo URL.$pagina[0]."/".$pagina[1]."/MAX/1/"; ?>">Precio
                            (Mayor a Menor)</a>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 col-md-4">
                <form class="mb-4 FormularioAjax" action="<?php echo URL; ?>ajax/buscadorAjax.php" data-form="search"
                    data-lang="<?php echo LANG; ?>" method="POST">
    ...
    <?php
            ...
            echo $ins_producto->niña_paginador_producto_controlador($pagina[3],10,$pagina[0],$pagina[2],$pagina[1],$_SESSION['busqueda_tienda']);
        ?>
</div>
