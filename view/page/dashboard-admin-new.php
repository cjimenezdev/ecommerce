...
<div class="container-fluid h-100 w-100 mt-5 d-flex flex-column justify-content-center">
    ...
    <div class="pt-18">
        <nav class="d-flex ms-2">
            <h6 class="mb-2">
                ...
                <span>/</span>
                <a href="<?php echo URL.DASHBOARD; ?>/admin-new/"
                            ...
                            <div class="col-12 col-sm-3">
                                <div class="d-flex justify-content-sm-end justify-content-start mt-3 mt-sm-0">
                                    <div class="form__outline w-sm-auto ms-sm-auto me-auto me-sm-0">
                                        <input type="search" id="txtbuscaUsuario" class="form__input w-100"
    ...
    <div class="row pb-4">
        <div class="col-12">
            ...
            $list_user = new administradorControlador();

            echo $list_user->controller_user_pager($pagina[2], 5, $pagina[1], "");
            ?>
            </div>
        </div>
    </div>
