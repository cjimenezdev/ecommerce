                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-center flex-column pt-4">
                        <p class="mb-0 font-weight-bolder">
                            <?php echo $_SESSION['usuario_sto']; ?>&nbsp;<?php echo $_SESSION['usuario_sto']; ?></p>
                        <span class="badge badge-light-primary"><?php echo $_SESSION['cargo_sto']; ?></span>
                    </div>
                    <div class=" mt-4">
                    ...
                    <div class="pt-2 d-flex flex-column">
                        <div class="d-flex align-items-center justify-content-start mb-4"><span
                                ...
                                class="text-muted ms-sm-3"><?php echo $_SESSION['usuario_sto']; ?></span></div>
                        <div class="d-flex align-items-center justify-content-start mb-4"><span
                                class="font-weight-bold">Estado:</span><span
                                class="badge badge-light-success ms-sm-3"><?php echo $_SESSION['estado_sto']; ?></span>
                        </div>
                        <div class="d-flex align-items-center justify-content-start mb-4"><span
                                class="font-weight-bold">Correo:</span><span
                                class="text-muted ms-sm-3"><?php echo $_SESSION['correo_sto']; ?></span></div>
                        <div class="d-flex align-items-center justify-content-start mb-4"><span
                                class="font-weight-bold">Celular:</span><span
                                class="text-muted ms-sm-3">0<?php echo $_SESSION['celular_sto']; ?></span></div>
                        <div class="d-flex align-items-center justify-content-start mb-4"><span
                                class="font-weight-bold">Cargo:</span><span
                                class="text-muted ms-sm-3"><?php echo $_SESSION['cargo_sto']; ?></span></div>
                        <div class="d-flex align-items-center justify-content-start"><span
                                class="font-weight-bold">Residencia:</span><span
                                class="text-muted ms-sm-3"><?php echo $_SESSION['direccion_sto']; ?></span></div>
                    </div>
                </div>
            </div>
        </div>
                                        ...
                                        <fieldset class="mb-4">
                                            ...
                                            <div class="col-12 col-lg-10 m-auto">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            name="usuario_estado_up" value="Deshabilitada"
                                                ...
                                                <div class="col-12 col-lg-10 m-auto">
                                                    <div class="form__outline mb-5">
                                                        <input type="tel" pattern="[0-9]{10}" class="form__input"
                                                            ...
                                                            value="0<?php echo $campos['usuario_telefono']; ?>"
