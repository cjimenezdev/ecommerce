    ...
    <div class="py-2">
        <nav class="d-flex mb-3 py-4 pb-2 ms-2">
            <h6 class="mb-0 mt-4">
                ...
                <a href="<?php echo URL; ?>admin/customer-new/">Cliente/</a>
                ...
                <div class="card-body">
                    ...
                    <div class="pt-2 d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center justify-content-start mb-4"><span
                                ...
                                class="text-muted ms-sm-3">0<?php echo $campos['cliente_celular']; ?></span></div>
                        <div class="d-flex align-items-center justify-content-start mb-4"><span
                                                ...
                                                <div class="col-12 col-lg-10 m-auto">
                                                    <div class="form__outline mb-5">
                                                        <input type="tel" pattern="[0-9]{10}" class="form__input"
                                                            ...
                                                            value="<?php echo '0'.$campos['cliente_celular']; ?>"
                                                            id="cliente_celular" maxlength="20" placeholder=" ">
                                                        <label for="cliente_celular"
