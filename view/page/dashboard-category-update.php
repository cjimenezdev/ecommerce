    ...
    <div class="py-2">
        <nav class="d-flex mb-3 py-4 pb-2 ms-2">
            <h6 class="mb-0">
                ...
                <a href="<?php echo URL; ?>admin/category-new/">Categoria/</a>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form__outline mb-4">
                                    <input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{4,49}" class="form__input"
                                        name="categoria_nombre_up" value="<?php echo $campos['categoria_nombre']; ?>"
                            ...
                            <div class="col-12">
                                <div class="form__outline mb-4">
                                    <textarea pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\s ]{4,700}" class="form__input"
                                        ...
                                        rows="50"><?php echo $campos['categoria_descripcion']; ?></textarea>
