...
<div class="bg-white full-box">
    <div class="container container-web-page">
        ...
        ?>
        <h3 class="font-weight-bold poppins-regular text-uppercase"><?php echo $nombre_categoria['categoria_nombre']; ?>
        </h3>
        ...
        <p class="text-justify">Bienvenido al menú de productos, acá encontrara todos los productos disponibles en
            nuestra tienda. Puede ordenar los productos por categoría en el botón "<i class="fas fa-tags fa-fw"></i>
            CATEGORÍAS" y también ordenarlos por orden alfabético o por precio en el botón "<i
                class="fas fa-sort-alpha-down fa-fw"></i> ORDENAR POR". Además, puede buscar productos por nombre
                        ...
                        <div class="dropdown-menu" aria-labelledby="categorySubMenu">
                            <?php
                                ...
                                while($campos_categoria=$datos_categoria->fetch()){
                                    echo '<a class="dropdown-item" href="'.URL.$pagina[0].'/'.$campos_categoria['categoria_id'].'/ASC/1/'.'">'.$campos_categoria['categoria_nombre'].'</a>';
                                }
                            ?>
                        </div>
                    </div>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="OrderSubMenu">
                            <a class="dropdown-item"
                                href="<?php echo URL.$pagina[0]."/".$pagina[1]."/ASC/1/"; ?>">Ascendente (A-Z)</a>
                            <a class="dropdown-item"
                                href="<?php echo URL.$pagina[0]."/".$pagina[1]."/DESC/1/"; ?>">Descendente (Z-A)</a>
                            <a class="dropdown-item"
                                href="<?php echo URL.$pagina[0]."/".$pagina[1]."/MIN/1/"; ?>">Precio (Menor a Mayor)</a>
                            <a class="dropdown-item"
                                href="<?php echo URL.$pagina[0]."/".$pagina[1]."/MAX/1/"; ?>">Precio (Mayor a Menor)</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12 col-md-8">
                    <p class="text-left lead"><i class="fas fa-search fa-fw"></i> &nbsp; Resultados de la búsqueda:
                        <span
                            class="font-weight-bold poppins-regular text-uppercase"><?php echo $_SESSION['busqueda_tienda']; ?></span>
                    </p>
                </div>
                <div class="col-12 col-md-4">
                    <form class="mb-4 FormularioAjax" action="<?php echo URL; ?>ajax/buscadorAjax.php"
                        data-form="search" data-lang="<?php echo LANG; ?>" method="POST">
...
<div class="modal fade" id="saucerModal" tabindex="-1" aria-hidden="true" aria-labelledby="saucerModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <form class="modal-content FormularioAjax" action="<?php echo URL; ?>ajax/buscadorAjax.php" data-form="default"
            data-lang="<?php echo LANG; ?>" method="POST" autocomplete="off">
            <input type="hidden" name="modulo" value="tienda">
            ...
            <div class="modal-body">
                <div class="form-outline mb-4">
                    <input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,30}" class="form-control"
                        name="busqueda_inicial" id="buscar_producto" maxlength="30">
                    <label for="buscar_producto" class="form-label">¿Qué estás buscando?</label>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" data-mdb-dismiss="modal"><i class="fas fa-times fa-fw"></i>
                    &nbsp; Cerrar</button>
