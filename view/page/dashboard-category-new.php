...
<div class="container-fluid h-100 w-100 mt-5">
    ...
    <div class="pt-18">
        <nav class="d-flex ms-2">
            <h6 class="mb-2">
                ...
                <span>/</span>
                <a href="<?php echo URL.DASHBOARD; ?>/category-new/"
                    class="text-primary text-decoration-underline disabled">Categorias</a>
            </h6>
        </nav>
    </div>
    <!-- Modal -->
            ...
            <div class="modal-content h-100">
                <div class="modal-header">
                    <div class="d-flex ms-2">
                        <h6 class="mb-0">
                            <a class="text-primary"><i class="fa-solid fa-plus"></i> Nueva Categoria</a>
                        </h6>
                    </div>
    ...
    <div class="row pb-4">
        <div class="col-12">
            ...
            echo $list_user->paginador_categoria_controlador($pagina[2], 5, $pagina[1], "");
            ?>
            </div>
        </div>
    </div>
